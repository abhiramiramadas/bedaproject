...
class AccidentDetectionGUI:
    ...
    def handle_accident(self, accident_data, frame):
        ...
        # detection.py uses 'vehicle_types' key
        ...
        # Log the accident
        log_msg = f"🚨 ACCIDENT DETECTED - Severity: {severity}, Impact: {impact:.1f}, Vehicles: {', '.join(vehicles)}"
        ...
        # Audio/Visual alert (limit to one popup every cooldown seconds)
...
Emergency services have been notified.
    ...
    def find_emergency_services(self):
        ...
        self.emergency_text.insert(tk.END, "🔍 Searching for emergency services...\n")
        self.root.update()
